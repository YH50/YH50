...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*
         *  Date에는 java.sql.Date와 java.util.Date가 존재,
         *  한 클래스에서 두 개의 타입을 전부 사용하게 되면 import를 하더라도 사용하는 타입이
         *  어느 패키지에 있는 Date 클래스인지에 대한 모호성이 발생하게 된다.
        ...
        * 기본 생성자로 인스턴스를 생성하면 운영체제의 날짜,시간 정보를 이용해서 인스턴스를 만들게 된다. */
        ...
        /* 2. Date(long date)를 사용하는 방법 */
        /* getTime() : 1970년 1월 1일 0시 0분 0초를 지난 시간을 밀리초로 계산해서 long 타입으로 변환 */

        System.out.println("today.getTime() = " + today.getTime()); //1712127129633
        Date Time = new Date(1712127129633L);
