...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * >> 2차원 배열은 1차원 배열 여러 개를 하나로 묶어서 관리하는 배열을 의미함.
        ...
        * */
        ...
        /*
        * 2차원 배열의 사용 방법
        * 1. 배열의 주소를 보관할 래퍼런스 변수의 선언(stack)
        * 2. 여러 개의 1차원 배열의 주소를 관리할 배열을 생성(heap)
        * 3. 각 인덱스에 관리하는 배열을 할당(heap)하여 주소를 보관하는 배열에 저장
        * 4. 생성한 여러 개의 일차원 배열에 차례대로 접근하여 사용
        * */

        /* 배열의 주소를 보관할 래퍼런스 변수의 선언(stack)*/
        ...
        /*
        * heap에 공간을 할당할 때 new 연산자를 이용한다.
        * 배열의 주소를 관리하는 배열의 길이는 앞부분에 정수형으로 표기하여
        * 반드시 크기를 저장해줘야 함.
        * */

        //iarr = new int[][];       //크기를 저장하지 않으면 에러 발생
