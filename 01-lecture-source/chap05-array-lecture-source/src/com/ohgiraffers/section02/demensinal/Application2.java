...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int[][] iarr = new int[3][5];       //길이가 5인 배열을 3개 할당하고
                                            //그 주소를 묶어서 관리하는 배열의 주소를
                                            //stack의 iarr에 저장한다.

        /* 2. 각 배열의 인덱스에 접근하여 값을 대입 후 출력 */
        /* 2-1. 각 인덱스 공간에 하나씩 접근하여 값을 대입 후 출력 */
        ...
        // 제대로 안 배우면 이렇게 개쌩노가다 해야한다 이말이야...


        /* 2-2. 반복문을 이용하여 값을 대입 후 출력 */
