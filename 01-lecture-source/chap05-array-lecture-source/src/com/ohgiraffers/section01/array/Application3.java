...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* 자바에서 지정한 기본값 외의 값을 초기화하고 싶은 경우 "블럭"을 이용함.
        * 블럭을 이용하는 경우에는 new를 사용하지 않아도 되며
        *               값의 개수만큼 자동으로 크기가 설정됨.
        * */
        ...
        int[] iarr3 = new int[]{11, 22, 33, 44};    //이런게 블럭임.
