...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업 목표 : 배열의 사용 방법을 익혀 배열을 사용할 수 있다. */
        /*
        * 배열의 사용방법
        * 1. 배열의 선언
        * 2. 배열의 할당
        ...
        * 발생한 주소를 reference( 참조) 형 변수에 저장하고
        *       이것을 참조하고 사용하기 때문에 참조자료형이라 한다.
        * */


        /*
        * 배열의 할당 시에는 반드시 배열의 크기를 ㅣ정해줘야 한다.
        * */
        //iarr= new int[];     >> 크기 지정 안해서 오류 발생
        iarr = new int[5];
        carr = new char[10];
        ...
        /* heap 메모리는 이름으로 접근이 아닌 주소로 접근하는 영역 */
        /* stack에 저장된 주소로 heap에 할당된 배열을 찾을 수 있다.
         * */
        ...
        * 동일한 객체인지 비교할 때 사용할 목적으로 쓰이며 동등 객체를 동일 객체 취급하기 위해
        * "오버라이딩"하여 사용한다.
        * */
        ...
        System.out.print("새로 할당할 배열의 길이를 입력 : ");
        int size = sc.nextInt();
        ...
        System.out.println("변경 후 darr의 hashcode : " +darr.hashCode());  //2094548358
