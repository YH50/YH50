...
public class Application {
    ...
    public static void main(String[] args) {
        /* 객체 지향 프로그래밍에 대해 이해하고 객체와 클래스를 설계하여 프로그래밍할 수 있다. */
        /*
         *  객체 지향 프로그래밍이란
        ...
        /*
        * 객체를 설계하기 위해서는 복잡한 현실 세계를 그대로 반영하기엔 너무 방대하고 복잡하기 때문에
        * 현실세계를 프로그램의 목적에 맞게 단순화하는 추상화의 기법을 적용하게 된다.
        * */
        ...
        *  >>> 여러 곳에 적용할 수 있는 유일한 객체를 의미하며 재사용성이 높아질 수 있다는 뜻이다.
        * 객체의 재사용성이 증가하면 중복으로 작성되는 코드를 줄일 수 있으며, 오류 발생 가능성을
        *       감소시키고 유지 보수성을 증가시킨다.
        * */
        ...
        * */
        ...
        /*
        * 프로그램 설계하기
        * 1. 필요한 객체를 도출하기 : 사용자, 카레이서, 자동차
        * 2. 객체 간의 상호작용
        *    >>> 카레이서가 수신할 수 있는 메시지(카레이서가 할 일)
        *          1)시동 걸기     2)악셀,브레이크 밟기        3)시동 끄기
        *    >>> 자동차가 수신할 수 있는 메시지(자동차가 할 일)
        *          1)시동 걸기     2)앞으로 가기, 멈추기       3)시동 끄기
        * */
        ...
        *    1. 시동 걸기
        ...
        /*
        * 4. 클래스 설계하기 (정적)
        * 필요한 클래스 : 1)카레이서  2)자동차   (사용자는 main으로 들어감)
        *
        * 1) 카레이서 클래스
        * - 속성 : 자동차
        * - 행위 : 시동걸기, 악셀.브레이크 밟기, 시동 끄기
        *
        * 2) 자동차 클래스
        * - 속성 : 시동의 상태, 현재 시속
