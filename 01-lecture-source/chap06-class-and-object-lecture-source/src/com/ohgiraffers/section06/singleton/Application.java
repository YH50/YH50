...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
         * singleton-pattern
         * >> 어플리케이션이 시작될 때 어떤 클래스가 최초 한 번만 메모리를 할당하고
         *    그 메모리에 인스턴스를 만들어서 하나의 인스턴스를 공유해서 사용하며
         *    메모리 낭비를 방지할 수 있도록 함.( = 매번 인스턴스 생성 안해도 됨)
         *
         * 장점
         * 1. 첫번째 이용 시에는 인스턴스를 생성해야 하므로 속도 차이가 나지 않지만
         *   두번째 사용 시에는 인스턴스 생성 시간 없이 사용 가능함.
         * 단점
         * 1. 싱글톤 인스턴스가 너무 많은 일을 하거나 많은 데이터를 공유하면 결합도가 높아짐.
         * 2. 동시성 문제를 고려해서 설계해야하기 때문에 난이도가 높음.
         *
         * */
        ...
        /*
        * 이른 초기화를 사용하면 클래스를 불러오는 속도가 느리지만
        * 처음 인스턴스 반환 요청에서 속도가 빠르다는 장점이 있다.
        *
        * 반면 게으른 초기화는 클래스 로드하는 속도는 빠르지만
        * 첫번째 요청에 대한 속도가 두번째 요청에 대한 속도보다 느리다는 특징이 있다.
        * */
