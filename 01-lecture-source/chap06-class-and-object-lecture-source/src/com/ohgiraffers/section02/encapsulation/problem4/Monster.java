...
public class Monster {
    ...
    /* 접근 제한자
    *  >> 클래스 혹은 클래스 멤버에 참조연산자로 접근할 수 있는 범위를 제한시키기 위한 키워드.
    * 1. public : 모든 패키지에 접근 허용
    * 2. protected : 동일 패키지 접근 허용. 단, 상속관계에 있는 경우 다른 패키지에서도 접근 가능
    * 3. default : 동일 패키지에"만" 접근 허용 (작성하지 않은 default)
    * 4. private : 해당 클래스 내부에서만 접근 가능
    * */

    /* 위 4가지 접근제한자는 클래스 멤버(필드, 메소드)에 모두 가능함.
    * BUT 클래스는 public, default 만 사용 가능하다.\
    * */
